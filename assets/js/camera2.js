document.addEventListener('DOMContentLoaded', function () {
    ...
    function proccessImg() {
        ...
        videoElement.onloadedmetadata = () => {
            console.log('Entroooo a procesarrr dataaaaaa');
            console.log('Tamaño del video with:', videoElement.videoWidth);
            console.log('Tamaño del video height:', videoElement.videoHeight);
